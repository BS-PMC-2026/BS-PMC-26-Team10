...
class TourCancellationConfirmationSmtpTests(unittest.TestCase):
    def _send_cancellation_email(self):
        return email_service.send_tour_cancellation_confirmation(
    ...
    def test_tour_cancellation_confirmation_uses_gmail_smtp(self):
        ...
        self.assertEqual(sent_message["Subject"], "ChiliLand Tour Booking Cancelled - ABC12345")

    def test_tour_cancellation_confirmation_returns_false_when_smtp_is_not_configured(self):
    ...
    def test_tour_cancellation_confirmation_returns_false_when_smtp_fails(self):
        smtp_context = MagicMock()
